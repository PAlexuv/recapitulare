...
public class UtilsdEL {
    ...
    //  read from properties files; citirea unui fisier properties se face cu Inputstream
    //    inputstream = preia informatia si o face un obiect de acel tip
    public static Properties readProperties(String path) throws IOException {
        InputStream inputStream = new FileInputStream(path);
        Properties properties = new Properties();
        properties.load(inputStream);
        return properties;// fisierul properties se transforma in HashMap: string | value in cazu nostru browser | chrome sau hostname | https://...
    }
    // take screenshots
